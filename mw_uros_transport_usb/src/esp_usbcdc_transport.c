 ...
 *
 * Les fonctions de ce fichier sont des callbacks imposés par l'interface
 * uxrCustomTransport de micro-ROS et doivent respecter les signatures
 * définies par micro-ROS (bool/size_t au lieu de esp_err_t).
 *
 * Ces signatures ne peuvent pas être modifiées sans casser la compatibilité
 * avec le système de transport custom de micro-ROS.
 */
